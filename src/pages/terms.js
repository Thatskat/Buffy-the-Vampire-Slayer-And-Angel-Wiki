  ...
  return (
    <div className="grid privacyPolicy">
      ...
      <div className="policySection">
        ...
        <p>
          a. The content on the Buffy the Vampire Slayer and Angel Wiki,
        ...
        <p>
          b. You may not reproduce, distribute, modify, or transmit any content
          from our wiki without obtaining prior written permission from the
          respective rights holders.
        </p>
        <p>
          c. Contributions made to the wiki are subject to our editing and
        ...
        <h3>User Conduct</h3>
        <p>
          a. You agree to use the Buffy the Vampire Slayer and Angel Wiki in a
          manner consistent with applicable laws and regulations.
        </p>
        <p>
          b. You will not engage in any activity that may disrupt or interfere
        ...
        <p>
          a. The wiki may contain links to external websites or resources. We
        ...
        <p>
          a. The Buffy the Vampire Slayer and Angel Wiki and its administrators,
        ...
        <p>
          b. We do not endorse any products, services, or opinions expressed on
          the wiki unless explicitly stated.
        </p>
        <h3>Modifications and Termination</h3>
        <p>
          a. We reserve the right to modify, suspend, or terminate the Buffy the
          Vampire Slayer and Angel Wiki or any part thereof, at any time and
          without notice.
        </p>
        <p>
          b. We may update these Terms of Use periodically, and it is your
